...
async function main() {
  ...
  console.log('Usage: dl.js [options]')
  console.log('  --anime               Search and download anime (interactive)')
  console.log('    --wholeshow         Queue whole show for download')
  console.log('    --transcode,--recode  Re-encode audio to AAC after download')
  console.log('    --path <dir>,--out <dir>  Output directory for downloads')
  console.log('  --tv|--series|--mtv   Search and download TV series (interactive)')
  console.log('    --wholeshow         Queue whole series/seasons')
  console.log('    --season <n>        Download only season n (can be repeated)')
  console.log('    --episode <n>       Download only episode n (can be repeated)')
  console.log('    --transcode,--recode  Re-encode audio to AAC after download')
  console.log('    --path <dir>,--out <dir>  Output directory for downloads')
  console.log('  --movie, -m           Search and download a movie (interactive)')
  console.log('    --transcode,--recode  Re-encode audio to AAC after download')
  console.log('    --path <dir>,--out <dir>  Output directory for downloads')
}
